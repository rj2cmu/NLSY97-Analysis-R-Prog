...
coca.income + geom_density(aes(fill = Ever_Used_Coca_1998), alpha = 0.3) + scale_color_manual(values = c("#999999", "#E69F00", "#56B4E9")) + scale_fill_manual(values = c("#999999", "#E69F00", "#56B4E9")) + labs(x="Income in $", y="Respondent density", title="Density Function for Income (Separated by Cocaine Usage)")
```
